    ...
    category_generator: function (locals) {
        ...
        langs.forEach(function (lang) {
            ...
            filtered.forEach(function (category) {
                pages = pages.concat(pagination(get_url(hexo, lang, category.path), filtered, {
                    perPage: perPage,
            ...
            if (enable_index_page) {
                pages = pages.concat(pagination(get_url(hexo, lang, 'categories'), filtered, {
                    perPage: perPage,
    ...
    tag_generator: function (locals) {
        ...
        langs.forEach(function (lang) {
            ...
            filtered.forEach(function (tag) {
                pages = pages.concat(pagination(get_url(hexo, lang, tag.path), filtered, {
                    perPage: perPage,
                    layout: ['tags', 'index'],
                    format: paginationDir + '/%d/',
            ...
            if (enable_index_page) {
                pages = pages.concat(pagination(get_url(hexo, lang, 'tags'), filtered, {
                    perPage: perPage,
